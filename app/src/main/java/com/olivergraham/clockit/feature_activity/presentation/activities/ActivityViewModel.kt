...
class ActivityViewModel @Inject constructor(
    ...
    private fun performClockOut(event: ActivityEvent.ClockOut) {
        viewModelScope.launch { ->
            ...
            val sessionTime = activity.totalTimeSpent - event.activity.totalTimeSpent
    ...
    /** Delete activity and show snackbar that can undo the delete */
    ...
    /** Add the recently-deleted activity back into the database */
